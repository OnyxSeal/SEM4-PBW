...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO mahasiswa (npm, namaM, jurusan, alamat) VALUES ('$npm', '$namaM', '$jurusan', '$alamat')";
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" id="npm" name="npm" placeholder="Masukkan NPM" required
                            value="<?php echo isset($data['npm']) ? $data['npm'] : ''; ?>">
                    </div>
                    <div class="form-group">
                        <label for="namaM">Nama:</label>
                        <input type="text" id="namaM" name="namaM" placeholder="Isi Nama Lengkap" required
                            value="<?php echo isset($data['namaM']) ? $data['namaM'] : ''; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat"
                            id="alamat"><?php echo isset($data['alamat']) ? $data['alamat'] : ''; ?></textarea>
                    </div>
                    <div class="form-group">
